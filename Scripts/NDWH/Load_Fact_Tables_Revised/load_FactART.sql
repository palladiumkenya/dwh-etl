IF OBJECT_ID(N'[ODS].[Dbo].[FactArt]', N'U') IS NOT NULL 
	DROP TABLE [ODS].[Dbo].[FactArt];
BEGIN
	...
	left join NDWH.dbo.DimRegimen lastreg on lastreg.Regimen=Patient.LastRegimen
	left join NDWH.dbo.DimRegimen firstreg on firstreg.Regimen=Patient.StartRegimen
