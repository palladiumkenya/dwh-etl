...
INSERT INTO REPORTING.dbo.AggregateDSD (MFLCode,FacilityName,County,SubCounty, CTPartner, CTAgency,Gender, AgeGroup, StabilityAssessment, patients_onMMD, patients_nonMMD, Stability, TXCurr)
SELECT DISTINCT
MFLCode,
f.FacilityName,
County,
