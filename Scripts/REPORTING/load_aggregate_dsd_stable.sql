...
INSERT INTO REPORTING.dbo.AggregateDSDStable (MFLCode,FacilityName,County,SubCounty, CTPartner, CTAgency,Gender, AgeGroup,DifferentiatedCare,  MMDModels, TXCurr)
SELECT DISTINCT
MFLCode,
f.FacilityName,
County,
